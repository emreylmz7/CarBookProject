...
namespace CarBookProject.Persistence.Migrations
{
    ...
    [Migration("20240402005241_mig_create_payment_invoice_review_identity")]
    partial class mig_create_payment_invoice_review_identity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarBook.Domain.Entities.Invoice", b =>
                {
                    ...
                    b.HasOne("CarBook.Domain.Entities.AppUser", "User")
                        .WithMany("Invoices")
